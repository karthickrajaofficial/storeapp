...
const Shop = () => {
  ...
  <div className="flex flex-col md:flex-row">
    <div className="bg-[#151515]  text-white p-3 md:ml-5 mt-2 mb-2">
      ...
      {/* <div className="p-5 w-[15rem] ">
        <input
          ...
          className="w-full px-3 py-2 placeholder-gray-400 border rounded-lg focus:outline-none focus:border-pink-300"
        />
      </div> */}
