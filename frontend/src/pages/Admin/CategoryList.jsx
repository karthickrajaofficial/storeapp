...
const CategoryList = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row mt-20 items-center justify-center md:ml-20">
      <AdminMenu className="w-full md:w-1/4 " />
      <div className="w-full md:w-3/4 p-3">
        <div className="h-12 text-center text-lg font-bold">Manage Categories</div>
        <CategoryForm
          value={name}
          setValue={setName}
